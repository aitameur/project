...
\pagestyle{fancy}
\fancyhf{}
\fancyhead[L]{\small\color{black}\textit{École Marocaine des Sciences de l'Ingénieur}}
\fancyhead[R]{\small\color{black}\textit{Rapport de Projet de Fin d'Année (PFA)}}
...
\titleformat{\section}
  ...
  {\thesection}{1em}{}
  [\vspace{-4pt}{\color{black}\rule{\linewidth}{0.5pt}}]
...
\caption{Diagramme de Gantt --- Planification du projet (16/03 au 06/05/2026)}
\end{figure}
\end{landscape}
...
développement logiciel. Le diagramme de Gantt visualise le planning sur 8 semaines
(16/03 au 06/05/2026) et organise le travail entre les deux membres. La répartition des ressources
...
suivant présente la dimension entrepreneuriale du projet.
